...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        self.layer.backgroundColor = [UIColor colorWithHexString:BaseColor].CGColor;
        ...
        _textLabel.font = [UIFont systemFontOfSize:15*SizeScale];
...
-(void)showWithAnimation:(BOOL)animation{
    ...
    NSInteger H = kDevice_Is_iPhoneX ? 34:0;
    ...
    if([self.controller.parentViewController isKindOfClass:[UINavigationController class]] && !self.controller.navigationController.navigationBar.isHidden){
        ...
        frame.origin.y = -DEFAULT_SPACE_IMG_TEXT+H ;
    }
